...
int main(int argc, char* argv[]) {
    try {
        ...
        if (l_VariablesMap.count("help")) {
            ...
            std::cout << "The satellite gateway software for the HDLC Daemon is Copyright (C) 2016, and GNU GPL'd, by Florian Evers." << std::endl;
        ...
        auto l_ConfigServerHandlerCollection  = std::make_shared<ConfigServerHandlerCollection>(l_IoService, l_VariablesMap["port"].as<uint16_t>());
